...
export default function TrustBadge() {
  return (
    <div className="relative py-6 px-4 sm:px-8 bg-indigo-50 border-b border-gray-200 text-black overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-1/2 h-1 bg-[#FCEB14] opacity-50"></div>
      ...
      <div className="absolute bottom-0 left-1/4 right-1/4 h-12 border-b-2 border-[#FCEB14] opacity-20 rounded-b-full"></div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 md:gap-10 w-full md:w-auto">
          ...
          <div className="group flex items-center space-x-3 transition-all duration-300 hover:translate-y-[-2px] w-full sm:w-auto">
            <div className="bg-white p-3 rounded-lg shadow-sm border border-indigo-200 group-hover:shadow-md group-hover:border-indigo-400 transition-all duration-300 group-hover:after:content-[''] group-hover:after:absolute group-hover:after:bottom-0 group-hover:after:left-0 group-hover:after:w-full group-hover:after:h-0.5 group-hover:after:bg-[#FCEB14] group-hover:after:opacity-60 relative overflow-hidden">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-indigo-600 group-hover:text-[#FCEB14] transition-colors duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="relative group self-center md:self-auto mt-4 md:mt-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#FCEB14] opacity-0 group-hover:opacity-60 transition-opacity duration-300"></div>
